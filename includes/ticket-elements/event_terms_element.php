...
class tc_event_terms_element extends TC_Ticket_Template_Elements {
	...
	function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
		if ( $ticket_instance_id ) {
			...
			$event_terms	 = apply_filters( 'the_content', get_post_meta( $event_id, 'event_terms', true ));
			...
			if ( $ticket_type_id ) {
				...
				return apply_filters( 'tc_event_terms_element', apply_filters( 'the_content', $event->details->event_terms ) );
			} else {
